...
set_target_properties(ical PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libical.so.3.0.4"
  IMPORTED_SONAME_NOCONFIG "libical.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS ical )
list(APPEND _IMPORT_CHECK_FILES_FOR_ical "${_IMPORT_PREFIX}/lib/libical.so.3.0.4" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ical-static "${_IMPORT_PREFIX}/lib/libical.a" )
...
set_target_properties(ical_cxx PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libical_cxx.so.3.0.4"
  IMPORTED_SONAME_NOCONFIG "libical_cxx.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS ical_cxx )
list(APPEND _IMPORT_CHECK_FILES_FOR_ical_cxx "${_IMPORT_PREFIX}/lib/libical_cxx.so.3.0.4" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_ical_cxx-static "${_IMPORT_PREFIX}/lib/libical_cxx.a" )
...
set_target_properties(icalss PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libicalss.so.3.0.4"
  IMPORTED_SONAME_NOCONFIG "libicalss.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS icalss )
list(APPEND _IMPORT_CHECK_FILES_FOR_icalss "${_IMPORT_PREFIX}/lib/libicalss.so.3.0.4" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_icalss-static "${_IMPORT_PREFIX}/lib/libicalss.a" )
...
set_target_properties(icalss_cxx PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libicalss_cxx.so.3.0.4"
  IMPORTED_SONAME_NOCONFIG "libicalss_cxx.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS icalss_cxx )
list(APPEND _IMPORT_CHECK_FILES_FOR_icalss_cxx "${_IMPORT_PREFIX}/lib/libicalss_cxx.so.3.0.4" )
...
list(APPEND _IMPORT_CHECK_FILES_FOR_icalss_cxx-static "${_IMPORT_PREFIX}/lib/libicalss_cxx.a" )
...
set_target_properties(icalvcal PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libicalvcal.so.3.0.4"
  IMPORTED_SONAME_NOCONFIG "libicalvcal.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS icalvcal )
list(APPEND _IMPORT_CHECK_FILES_FOR_icalvcal "${_IMPORT_PREFIX}/lib/libicalvcal.so.3.0.4" )
...
set_target_properties(ical-glib PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libical-glib.so.3.0.4"
  IMPORTED_SONAME_NOCONFIG "libical-glib.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS ical-glib )
list(APPEND _IMPORT_CHECK_FILES_FOR_ical-glib "${_IMPORT_PREFIX}/lib/libical-glib.so.3.0.4" )
